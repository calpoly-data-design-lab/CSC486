...
- Explain fundamentals of human-computer interaction.  
- Identify human capabilities and limitations for interaction with computers.
- Use sensors and actuators suitable for human-computer interaction purposes to provide alternatives to traditional input/output devices.  
- Contrast human-computer interaction spaces, styles, and paradigms.  
- Explain constraints related to environment, devices, and tasks.
- Assess natural user interface capabilities and challenges.
- Explain potential applications for affective, pervasive, or social computing and other emerging technologies.  
- Apply human-computer interaction principles and practices to the development of interactive applications as a member of a team.  
- Analyze and evaluate the user experience of interactive systems using qualitative and quantitative methods.  
- Prepare and deliver effective technical oral presentations.
...
- Final Project (30%):
  ...
  - Final Project Literature Review (5%)
...
- _A_ ∈[100, 93];   _A–_ ∈[92,90]
- _B+_ ∈[89,87]; _B_ ∈[86,83]; _B–_ ∈[82, 80]
- _C+_ ∈[79,77]; _C_ ∈[76,73]; _C–_ ∈[72, 70]
- _D+_ ∈[69,67]; _D_ ∈[66,63]; _D–_ ∈[62, 60]
- _F_ ∈[60,0]
...
While slides will be made available after class, they are **NOT** designed to be a standalone, complete, course notes reference. Slides are used to augment lecture, but you are responsible for the content _actually covered_ during lecture, in addition to any assigned readings. Therefore I **highly recommend** taking your own notes (physical written notes generally are shown to be the most effective in assisting in the retention of material) as well as sharing notes and helping each other when studying or if you are a classmate has to miss a lecture.

### Textbooks

This course will be using two primary reference textbooks that are _recommended_ but not required.

- _Human-Computer Interaction: An Empirical Research Perspective_, I. Scott MacKenzie
- _Interaction Design: Beyond Human-Computer Interaction_, Yvonne Rogers, Helen Sharp, and Jennifer Preece
...
In addition to these textbooks there is one additional required reading: _The Design of Everyday Things_, by Don Norman (2013). I highly recommend you get a physical copy, but digital and audio copies are available. Finally, there will be a few research papers assigned towards the end of the quarter which will be accessible through Cal Poly and the ACM Digital Library. However, again, if you have any issues just come talk to me and I will help you get access to all materials.
...
- We all treat each other with dignity and kindness, recognize the diversity our backgrounds and experiences, and remain open-minded and willing to challenge our beliefs without denigrating any people inside or outside of the classroom.
- We are not snobs. We do not assume background knowledge or imply there are things that somebody should already know or do in order to be a member of the community.
